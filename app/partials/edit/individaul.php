  		...
  		<form action="" method="POST">
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
					...
					<select class="form-control" id="rooms" name="rooms">
					      <option value="single_room" <?php if($data['rooms'] == 'single_room'){echo 'selected';}?>>Single Room</option>
					      <option value="double_room" <?php if($data['rooms'] == 'Double_room'){echo 'selected';}?>>Double Room</option>
					      <option value="bedsitter" <?php if($data['rooms'] == 'bedsitter'){echo 'selected';}?>>Bedsitter</option> 
					      <option value="one_bedroom" <?php if($data['rooms'] == 'one_bedroom'){echo 'selected';}?>>1 Bedroom house</option> 
					      <option value="two_bedroom" <?php if($data['rooms'] == 'two_bedroom'){echo 'selected';}?>>2 Bedroom house</option> 
					    </select>
					    </select>
			...
			<div class="row">
			 ...
			 <div class="form-group">
			  ...
			  <div class="col-md-4">
			  <div class="form-group">
			    <label for="deposit">Deposit required</label>
