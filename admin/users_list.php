...
if (!empty($_SESSION['id'])) {
    $stmt = $connect->prepare('
            SELECT 
                ...
                u.username, 
                u.full_name, 
                COUNT(a.apartment_id) AS apartments
            FROM 
                users u
            LEFT JOIN 
                apartments a ON u.user_id = a.user_id AND a.deleted = 0
            GROUP BY 
                u.user_id
            ORDER BY 
                u.user_id DESC;
        ...
        <div id="layoutSidenav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="./new_apt.php"><s>NEW Apartment</s></a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <ol class="breadcrumb mb-2 mt-2 d-flex justify-content-between">
                        <li class="breadcrumb-item active">All users</li>
                        <li class="">
                            <a href="./add_user.php" class="btn btn-sm btn-outline-success">New User</a>
                        </li>
                    </ol>
                        <div class="card mb-4">
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Aparments</th>
                                            </tr>
                                        </thead>
                                        <tbody id="usersTableBody">
                                            <?php
                                                if (isset($responce['users'])) {
                                                    $counter = 1;
                                                    foreach ($responce['users'] as $user) {
                                                        echo "<tr>";
                                                        echo "<th scope='row'>".$user['user_id']."</th>";
                                                        echo "<td><a href='../admin/user_details.php?user_id={$user['user_id']}'>{$user['username']}</a></td>";
                                                        echo "<td>{$user['full_name']}</td>";
                                                        echo "<td><a href='./apartments.php?user_id={$user['user_id']}'>". $user['apartments'] ."</a></td>";
                                                        echo "</tr>";
                                                        $counter++;
                                                    }
                                                } else {
