                ...
                <main>
                    <div class="container-fluid px-3">
                        <ol class="breadcrumb mb-4 mt-2">
                            ...
                            <li class="breadcrumb-item active">Apartments for All users </li>
                        </ol>
                        <div class="card mb-4">
                                            ...
                                            <?php
                                                if (isset($responce['apartments'])) {
                                                    ...
                                                    foreach ($responce['apartments'] as $apartment) {
                                                        ...
                                                        echo "<td><a href='./apt_details.php?apartment_id={$apartment['apartment_id']}'>{$apartment['name']}</a></td>";
                                                        echo "<td>{$apartment['rooms']}</td>";
                                                        echo "<td><a href='./new_room.php?apartment_id={$apartment['apartment_id']}'>Add room</a></td>";
                                                        echo "</tr>";
                                                        $counter++;
                                                    }
                                                } else {
        ...
        <script>
            ...
            function displayApartments(apartments) {
                ...
                apartments.forEach(apartment => {
                    ...
                    const url = `../admin/apt_details.php?apartment_id=${apartment.apartment_id}`;
