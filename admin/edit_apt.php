                                ...
                                <div class="row">
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="CCTV" name="facilities[]" value="CCTVs" <?php echo (is_array($facilitiesArray) && in_array('CCTVs', $facilitiesArray)) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="CCTV">CCTVs</label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="Alarm" name="facilities[]" value="Alarm" <?php echo (is_array($facilitiesArray) && in_array('Alarm', $facilitiesArray)) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="Alarm">Alarm response</label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="Generator" name="facilities[]" value="Generator" <?php echo (is_array($facilitiesArray) && in_array('Generator', $facilitiesArray)) ? 'checked' : ''; ?>>
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="facilities">Other facilities</label>
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="parking" name="facilities[]" value="Parking" <?php echo (is_array($facilitiesArray) && in_array('Parking', $facilitiesArray)) ? 'checked' : ''; ?>>
                                          ...
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="kitchen-shelves" name="facilities[]" value="kitchen shelves" <?php echo (is_array($facilitiesArray) && in_array('kitchen shelves', $facilitiesArray)) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="kitchen-shelves">Kitchen shelves</label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="wardrobe" name="facilities[]" value="wardrobe" <?php echo (is_array($facilitiesArray) && in_array('wardrobe', $facilitiesArray)) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="wardrobe">Wardrobe</label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="balcony" name="facilities[]" value="balcony" <?php echo (is_array($facilitiesArray) && in_array('balcony', $facilitiesArray)) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="balcony">Balcony</label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="natural-lighting" name="facilities[]" value="Natural lighting" <?php echo (is_array($facilitiesArray) && in_array('Natural lighting', $facilitiesArray)) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="natural-lighting">Natural lighting</label>
                                          </div>
                                          <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="air-conditioning" name="facilities[]" value="Air Conditioning" <?php echo (is_array($facilitiesArray) && in_array('Air Conditioning', $facilitiesArray)) ? 'checked' : ''; ?>>
