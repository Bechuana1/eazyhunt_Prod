                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="apartment_name" placeholder="If Name is not available, fill in N/A " name="apartment_name">
                                    </div>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <div class="form-check">
                                          <input class="form-check-input" type="checkbox" id="gateman" name="facilities[]" value="Soldier">
                                          <label class="form-check-label" for="gateman">Watchman / Soldier</label>
                                        </div>
                                        <div class="form-check">
