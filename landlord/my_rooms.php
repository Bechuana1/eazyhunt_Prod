...
try {
    $sql = "
        ...
        WHERE 
            r.user_id = :user_id AND a.deleted = 0
        GROUP BY 
...
<html lang="en">
    <head>
        ...
        /* Aspect ratio for horizontal images */
        .img-container.horizontal {
            padding-top: 60%; /* Aspect ratio 5:3 */
        }

        /* Aspect ratio for vertical images */
        ...
        @media (min-width: 768px) {
            .img-container.horizontal {
                padding-top: 50%; /* Adjust aspect ratio for tablets */
            }
        }
        @media (max-width: 767px) {
            .img-container.horizontal {
                padding-top: 75%; /* Adjust aspect ratio for mobile devices */
            }
        }
    </style>
    </head>
    ...
    function viewImages(imageUrls) {
        ...
        if (imageUrls) {
            ...
            col.classList.add('col-md-4', 'mt-3'); // Adjust column size and margin

            var container = document.createElement('div');
            container.classList.add('img-container', 'horizontal'); // Apply the horizontal class

            var img = document.createElement('img');
            img.src = url.trim();
            img.alt = 'Room Image';
            img.classList.add('img-fluid'); // Apply Bootstrap's responsive image class
